...
void ULootLockerServerAssetInstanceRequest::GetAllKeyValuePairs(
    ...
    const FLootLockerServerAssetInstanceStorageItemsResponseDelegateBP& OnCompletedRequestBP,
    const FLootLockerServerAssetInstanceStorageItemsResponseDelegate& OnCompletedRequest)
{
    const FServerResponseCallback SessionResponse = FServerResponseCallback::CreateLambda([OnCompletedRequestBP, OnCompletedRequest](FLootLockerServerResponse response)
        {
            FLootLockerServerAssetInstanceStorageItemsResponse ResponseStruct;
            if (response.success)
            {
                FJsonObjectConverter::JsonObjectStringToUStruct<FLootLockerServerAssetInstanceStorageItemsResponse>(response.FullTextFromServer, &ResponseStruct, 0, 0);
...
void ULootLockerServerAssetInstanceRequest::UpdateKeyValuePairs(int PlayerId, int AssetInstanceId, const TArray<FLootLockerServerAssetInstanceStorageItem>& Pairs, const FLootLockerServerAssetInstanceStorageItemsResponseDelegateBP& OnCompletedRequestBP, const FLootLockerServerAssetInstanceStorageItemsResponseDelegate& OnCompletedRequest)
{
    const FServerResponseCallback SessionResponse = FServerResponseCallback::CreateLambda([OnCompletedRequestBP, OnCompletedRequest](FLootLockerServerResponse response)
        {
            FLootLockerServerAssetInstanceStorageItemsResponse ResponseStruct;
    ...
    FLootLockerServerAssetInstanceStorageItems Request;
    Request.storage = Pairs;
    FJsonObjectConverter::UStructToJsonObjectString(FLootLockerServerAssetInstanceStorageItems::StaticStruct(), &Request, ContentString, 0, 0);
...
void ULootLockerServerAssetInstanceRequest::CreateKeyValuePair(
    int PlayerId, int AssetInstanceId, const FLootLockerServerAssetInstanceStorageItem& Pair,
    const FLootLockerServerAssetInstanceStorageItemsResponseDelegateBP& OnCompletedRequestBP,
    const FLootLockerServerAssetInstanceStorageItemsResponseDelegate& OnCompletedRequest)
{
    const FServerResponseCallback SessionResponse = FServerResponseCallback::CreateLambda([OnCompletedRequestBP, OnCompletedRequest](FLootLockerServerResponse response)
    ...
    FString ContentString;
    FJsonObjectConverter::UStructToJsonObjectString(FLootLockerServerAssetInstanceStorageItem::StaticStruct(), &Pair, ContentString, 0, 0);
...
void ULootLockerServerAssetInstanceRequest::UpdateKeyValuePair(int PlayerId, int AssetInstanceId, int PairId, const FLootLockerServerAssetInstanceStorageItem& Pair, const FLootLockerServerAssetInstanceStorageItemsResponseDelegateBP& OnCompletedRequestBP, const FLootLockerServerAssetInstanceStorageItemsResponseDelegate& OnCompletedRequest)
{
    const FServerResponseCallback SessionResponse = FServerResponseCallback::CreateLambda([OnCompletedRequestBP, OnCompletedRequest](FLootLockerServerResponse response)
        {
            FLootLockerServerAssetInstanceStorageItemsResponse ResponseStruct;
